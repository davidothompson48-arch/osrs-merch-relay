...
def main():
    ...
    lite={
        "schema_version":3,"generated_at":p.get("generated_at"),"generated_unix":p.get("generated_unix"),"source":p.get("source"),"quality":p.get("quality"),
        ...
        "deep_packet":"desk_packet.json","rule":"Routine desk runs should use this lite packet only. Use the marginal-capital ladder for incremental GP, the absolute-velocity frontier for total GP/hour, and the balanced frontier for final risk-adjusted ranking. Fetch the deep packet solely for missing fields or a user-requested deep dive."
    }
